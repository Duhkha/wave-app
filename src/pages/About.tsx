    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-slate-800 mb-4">About Wave App</h1>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 mb-8">
          <h2 className="text-2xl font-bold text-slate-800 mb-6 text-center">What We Believe In</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-600">Every line of code is crafted with attention to detail and excellence.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">User Centered</h3>
              <p className="text-slate-600">Our users' needs and feedback drive every decision we make.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">We constantly explore new technologies to stay ahead of the curve.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl p-8 text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <button className="border border-slate-300 text-slate-700 font-medium px-6 py-3 rounded-lg hover:bg-slate-100 transition-colors">
              Learn More
            </button>
          </div>
        </div>
