...
const Sidebar: React.FC<SidebarProps> = ({ items = [] }) => {
  const { isOpen, closeSidebar, toggleSidebar, sidebarWidth: expandedWidth } = useSidebar();
  ...
  const defaultItems: SidebarItem[] = [
    ...
    { 
      ...
      label: "Conflict Testing", 
      path: "/conflict-testing" 
    },
  ];
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          width: isMobile ? (isOpen ? `${expandedWidth}px` : '0') : (isOpen ? `${expandedWidth}px` : `${collapsedWidth}px`),
        }}
      >
        <nav className="pt-20">
